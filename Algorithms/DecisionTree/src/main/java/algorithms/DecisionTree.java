...
public abstract class DecisionTree {
    ...
    public static DecisionTree splitNode(int featureIndex, DecisionTree left, DecisionTree right) {
         return new InternalNode(featureIndex, left, right);
    }

    public static class LeafNode extends DecisionTree {
    ...
    public static class InternalNode extends DecisionTree {
        ...
        private final DecisionTree left, right;

        public InternalNode(int featureIndex, DecisionTree left, DecisionTree right) {

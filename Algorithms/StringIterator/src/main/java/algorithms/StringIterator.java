...
public class StringIterator {
    ...
    private static class IterableStringImpl implements IterableString {
        private final String string;

        public IterableStringImpl(String string) {
            this.string = string;
        }

        @Override
        public Iterator<Character> iterator() {
            return new StringCharIterator(string);
        }
    }

    private static class StringCharIterator implements Iterator<Character> {
        private final String string;
        private int index;

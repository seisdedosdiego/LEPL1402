...
public abstract class DecisionTree {
     ...
     */
     public static DecisionTree splitNode(int featureIndex, DecisionTree left, DecisionTree right) {
          return new InternalNode(featureIndex, right, left);
     }
     ...
     */
     ...
     private static class InternalNode extends DecisionTree {
          private final int featureIndex;
          private final DecisionTree right;
          private final DecisionTree left;

          public InternalNode(int featureIndex, DecisionTree right, DecisionTree left) {
